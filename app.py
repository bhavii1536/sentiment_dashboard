...
lang_choice = st.sidebar.selectbox("🌐 Language", ["English", "Tamil", "Hindi"], index=0)
...
st.write("")
st.caption("Tip: Set your YT API key in Streamlit secrets. For Twitter, either provide API keys or rely on snscrape fallback.")
